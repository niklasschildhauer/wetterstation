/**
 * @author Lukas Smirek - modified by Wetterstation team
...
const XMLHttpRequest = xmlhttpRequest.XMLHttpRequest;
 ...
 let openAPE_API = {
    ...
    openApeServerUrl: "https://openape.gpii.eu",
...
var openAPE = {
     ...
     * @param {string} [serverUrl="https://openape.gpii.eu"] - URL of the server to which the client connects.
     * @returns {boolean}
     */
...
class Client {
     ...
     * @param {string} [serverUrl="https://openape.gpii.eu"] - The URL of the server to connect to.
     * @param {string} [defaultContentType="JSON"] - The content type to be used a default. Can be "JSON" or "XML".
     */
    constructor(username, password, serverUrl, defaultContentType = openAPE_API.defaultContentType) {
     ...
     */
    getUserContextList(successCallback, errorCallback) {
        return this.getContextList(openAPE_API.userContextPath, successCallback, errorCallback);
    }
